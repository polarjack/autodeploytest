...
const input = fs.readFileSync('AgreementNew.sol');
const output = solc.compile(input.toString(), 1);
const bytecode = output.contracts['Agreement'].bytecode;
const abi = JSON.parse(output.contracts['Agreement'].interface);
